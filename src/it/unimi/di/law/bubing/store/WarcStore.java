...
public class WarcStore implements Closeable, Store {
	...
	@Override
	public void store(final URI uri, final HttpResponse response, final boolean isDuplicate, final byte[] contentDigest, final String guessedCharset, final Map<String, String> additionalInformation) throws IOException, InterruptedException {
